---
title: 'Introduction'
description: Introduction | HTML | Rebase
---
...
To carry out the activities in this module you can use any modern web browser. Just as a reminder, we recommend you download the[ Mozilla web browser](https://www.mozilla.org/es-ES/firefox/new/), as we mentioned in the [Prework module](https://curriculum.rebase.academy/prework/introduction). Of course, feel free to use any browser you feel more comfortable with, this is just a recommendation considering that we're going to be developing for the web.

Apart from that, [you'll need to have in your computer some IDE to write your code](https://www.notion.so/rebase-Prework-bf2f2c44f7f44a3f869dfb8a06349b60). You should have done this in the [Prework module](https://curriculum.rebase.academy/prework/introduction), so in case you haven't done it yet, just refer to that part of the material and install it now.
